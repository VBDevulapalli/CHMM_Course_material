...
> **Use this ONLY after studying the Complete Notes. This is your rapid-review sheet for daily commute reading and last-minute exam prep.**

---

## 🗂️ EPCRA SECTION MAP

| Section | Name | Trigger | Recipients | Deadline |
|---------|------|---------|------------|----------|
| **302** | EHS Planning | EHS ≥ TPQ on-site | SERC + LEPC | 60 days of trigger |
| **303** | Local Emergency Plan | LEPC obligation | LEPC creates the plan | Annual review required |
| **304** | Emergency Release Notification | Release ≥ RQ of EHS or CERCLA substance | LEPC + SERC (+ NRC for CERCLA) | IMMEDIATE oral; written ASAP |
| **311** | SDS/Chemical List Submission | OSHA HazCom chemical above threshold | LEPC + SERC + fire dept | Within 3 months of first storage |
| **312** | Tier II Annual Inventory | Same chemicals as 311 | LEPC + SERC + fire dept | **MARCH 1** annually |
| **313** | TRI / Form R | Manufacture/process ≥ 25K lbs OR use ≥ 10K lbs | EPA (TRI-MEweb) | **JULY 1** annually |
...
## 🏛️ LEPC REQUIRED MEMBERSHIP (9 Categories)
...
5. First aid / EMS
6. Health officials
7. Local environmental and transportation officials
8. ★ BROADCAST AND PRINT MEDIA ← always tested
9. Facility owners and operators subject to EPCRA
```

---

## ⚠️ EHS Threshold Planning Quantities (Selected)

| Chemical | TPQ | Why It Matters |
|----------|-----|----------------|
| Phosgene | 10 lbs | WWI chemical weapon — extreme lethality |
| Chlorine | 100 lbs | Common industrial gas — highly toxic |
| Hydrogen Fluoride | 100 lbs | Deeply penetrating, systemic toxin |
| Methyl Isocyanate (Bhopal) | 500 lbs | Worst industrial disaster chemical |
| Anhydrous Ammonia | 500 lbs | Refrigerant, fertilizer — toxic gas |
| Sulfur Dioxide | 500 lbs | Common industrial, severe respiratory irritant |

---

## 📊 TIER II vs TRI — Side by Side

| | Tier II (Section 312) | TRI / Form R (Section 313) |
|--|----------------------|--------------------------|
| **What** | Chemical inventory (amounts stored) | Actual releases to environment |
| **When** | March 1 | July 1 |
| **To whom** | LEPC, SERC, fire dept | EPA (TRI-MEweb) |
| **Thresholds** | EHS: ≥ TPQ or 500 lb; Other: ≥ 10,000 lb | Manufacture/Process: ≥ 25,000 lb; Use: ≥ 10,000 lb |
| **Public?** | Yes — public upon request | Yes — fully public in TRI database |
| **Covers** | All OSHA hazard chemicals | Listed TRI chemicals only (800+) |
| **Includes permitted releases?** | N/A — this is inventory | YES — includes routine/permitted releases |
...
## 👥 FOUR PRP CATEGORIES (CERCLA Section 107a)
...
## ☎️ REPORTABLE QUANTITIES — QUICK REFERENCE

| RQ | Examples |
|----|---------|
| **1 lb** | Dioxin, radionuclides, DEFAULT for unlisted substances |
| **10 lbs** | Chlorine, hydrogen fluoride, hydrogen sulfide |
| **100 lbs** | Ammonia, arsenic, chromic acid |
...
| Law | CFR Location | Key Agency |
|-----|-------------|-----------|
| EPCRA | 40 CFR Parts 355, 370, 372 | EPA |
| CERCLA | 40 CFR Part 300 (NCP), Part 302 (RQ) | EPA |
| RCRA Manifest | 40 CFR Parts 262-263 | EPA |
| SARA | Multiple | EPA |
| NCP | 40 CFR Part 300 | EPA/USCG |
