# DAY 1 — 100 PRACTICE QUESTIONS
## Full CHMM-Style Exam Questions with Answers & Explanations

---

# BLOCK 1: What Is a Hazardous Material (Q1–Q10)

**Q1.** A facility discards a solvent that is no longer useful for its original purpose. Under which EPA framework does this material now fall?

A) TSCA — because it is a chemical substance  
B) RCRA — because it is now a solid/hazardous waste  
...
**Q2.** A truck carrying flammable liquids is involved in a highway accident. Which agency's regulations primarily govern the emergency response to the hazardous materials on that truck?

A) EPA under RCRA  
B) OSHA under HAZWOPER  
C) DOT under 49 CFR  
...
**Q3.** Which of the following best describes the difference between how DOT and EPA use the term "hazardous material"?

A) DOT focuses on workplace exposure; EPA focuses on transportation risk  
B) DOT focuses on unreasonable risk during transport; EPA focuses on environmental threat from discarded materials  
...
**Q4.** A chemical is classified as a DOT hazardous material for transport but is NOT listed as a RCRA hazardous waste. Which statement is correct?

A) This is impossible — all DOT hazardous materials are also RCRA hazardous wastes  
B) This can occur because the two regulatory systems use different criteria  
...
**Q5.** Nuclear Regulatory Commission (NRC) jurisdiction covers which of the following?

A) All radioactive materials including military nuclear weapons  
B) Civilian use of radioactive materials such as medical and research applications  
...
**Q6.** A manufacturing company uses a hazardous chemical in its production process and never discards it. Which agency's regulations are most directly applicable?

A) EPA under RCRA  
B) OSHA under HazCom (29 CFR 1910.1200)  
...
**Q7.** The ATSDR primarily serves what function in the hazardous materials regulatory framework?

A) Enforces RCRA hazardous waste regulations at industrial facilities  
B) Issues permits for hazardous waste treatment facilities  
...
**Q8.** A facility stores large quantities of toxic chemicals but has never generated any waste. Which federal law requires the facility to notify the local emergency planning committee of these chemical inventories?
...
**Q9.** Which of the following is NOT within OSHA's jurisdiction?

A) Private sector manufacturing plant workers  
B) State and local government employees in states with OSHA-approved state plans  
...
**Q10.** A release of a CERCLA hazardous substance at or above its Reportable Quantity must be reported to which entity within 24 hours?

A) The Local Emergency Planning Committee (LEPC) only  
B) The State Emergency Response Commission (SERC) only  
...
# BLOCK 2: Physical and Chemical Properties — Flammability (Q11–Q25)

**Q11.** A liquid has a flash point of 85°F (29.4°C). Under OSHA's classification, this material is:
...
**Q12.** The autoignition temperature (AIT) of diethyl ether is approximately 160°C. What does this mean in practical terms?

A) Diethyl ether requires an ignition source to catch fire at all temperatures  
B) Diethyl ether will spontaneously ignite if the ambient temperature reaches 160°C, even without a spark  
...
**Q13.** Methane has an LEL of 5% and UEL of 15%. A confined space measurement shows methane at 20% of the atmosphere. Which statement is correct?

A) The atmosphere is explosive and immediately dangerous  
B) The atmosphere is above the UEL and will not ignite in its current state, but is oxygen-deficient and dangerous  
...
**Q14.** You are reviewing an SDS and find that a chemical has a vapor density of 2.1. Where would you expect this vapor to accumulate following a spill indoors?

A) Near ceiling vents and upper walls  
B) In low-lying areas such as floor level, drains, and basements  
...
**Q15.** A chemical has a vapor pressure of 400 mmHg at 20°C. Compared to water (17.5 mmHg at 20°C), this chemical will:

A) Evaporate much more slowly than water  
B) Evaporate much more rapidly than water, producing higher atmospheric concentrations  
...
**Q16.** A flammable liquid's fire point is best described as:

A) Identical to the flash point for all practical purposes  
B) The temperature at which the liquid ignites and sustains continuous combustion  
...
**Q17.** Which of the following flammable range characteristics indicates the MOST hazardous material from an explosion standpoint?

A) LEL = 1.5%, UEL = 8.5% (range of 7%)  
B) LEL = 4.0%, UEL = 75% (range of 71%)  
...
**Q18.** Propane has a vapor density of 1.56 and methane has a vapor density of 0.55. In the event of a leak inside a building, which gas poses the greater basement accumulation risk?

A) Methane, because it is lighter and spreads throughout the building faster  
B) Propane, because it is heavier than air and will sink and pool in low areas  
...
**Q19.** Under DOT regulations, a flammable liquid is classified as:

A) Class 2, Division 2.1  
B) Class 3  
...
**Q20.** A chemical's SDS shows a flash point of 25°C. A storage room regularly reaches temperatures of 30°C in summer. What is the primary concern?

A) The chemical will decompose at 30°C  
B) The storage room temperature exceeds the flash point, meaning flammable vapors could accumulate and ignite  
...
**Q21.** Which of the following chemicals would be classified as DOT Class 4, Division 4.3?

A) A solid that burns rapidly when ignited in air  
B) A solid that ignites spontaneously in air within 5 minutes  
...
**Q22.** A NFPA 704 placard shows Red = 4, Blue = 3, Yellow = 2, White = W̄. What does the White W̄ symbol indicate?

A) This material is an oxidizer  
B) This material reacts dangerously with water and water should not be used on a fire  
...
**Q23.** Which classification represents the MOST dangerous explosive under DOT Class 1?
...
**Q24.** An organic peroxide is classified under which DOT hazard class?

A) Class 3  
B) Class 5, Division 5.2  
...
**Q25.** What does Packing Group I designation indicate for a hazardous material?

A) The material presents minor danger and requires minimal packaging  
B) The material presents medium danger  
...
# BLOCK 3: Toxicology (Q26–Q40)

**Q26.** Chemical A has an oral LD50 of 50 mg/kg and Chemical B has an oral LD50 of 500 mg/kg. Which chemical is more toxic?

A) Chemical B, because the higher number means greater toxicity  
B) Chemical A, because a lower LD50 means it takes less of the substance to cause lethality  
...
**Q27.** The IDLH value for hydrogen sulfide (H₂S) is 100 ppm. What does this mean for emergency responders?

A) Workers can safely work in 100 ppm H₂S without any respiratory protection  
B) Above 100 ppm, workers cannot escape within 30 minutes without irreversible health effects or escape-impairment  
...
**Q28.** A worker is exposed to a solvent for 10 hours instead of the standard 8 hours. To calculate whether the exposure complies with the TLV-TWA, you would:

A) Compare the measured concentration directly to the published TLV-TWA without adjustment  
B) Use a Brief and Scala model or similar correction factor to adjust the TLV downward for extended shifts  
...
**Q29.** Which route of exposure provides the fastest path for a chemical to enter the bloodstream?

A) Dermal absorption through intact skin  
B) Ingestion through the gastrointestinal tract  
...
**Q30.** Benzene exposure is best characterized as what type of health hazard?

A) Acute toxin causing immediate liver failure  
B) Chronic carcinogen — causes leukemia with long-term low-level exposure  
...
**Q31.** The TLV-C for a substance is 5 ppm. A monitoring instrument reads 6 ppm for just 3 seconds during a 10-hour shift. Is this a violation?

A) No, because it was only 3 seconds, well under the 15-minute STEL period  
B) No, because the 8-hour TWA will likely be well below the TLV-TWA  
...
**Q32.** Which of the following scenarios demonstrates biomagnification?

A) Lead accumulates in a worker's bone tissue over 20 years of occupational exposure  
B) Mercury concentrations are higher in tuna than in the small fish tuna eat, and highest in eagles that eat tuna  
...
**Q33.** Hydrofluoric acid (HF) is particularly dangerous compared to other acids because:

A) It has a very low pH that causes immediate visible skin burns  
B) It is an oxidizer that causes secondary fires  
...
**Q34.** A toxicologist states "the dose makes the poison." What fundamental principle does this reflect?

A) All synthetic chemicals are inherently more toxic than natural ones  
B) Any substance can be toxic at a sufficient dose; toxicity is a function of dose, not just chemical identity  
...
**Q35.** Which type of radiation requires the heaviest shielding material?

A) Alpha particles — require lead shielding  
B) Beta particles — require thick concrete  
...
**Q36.** An LC50 value is most appropriately used when evaluating exposure via which route?
...
**Q37.** A worker develops cancer 25 years after regular exposure to a chemical in the workplace. This represents:

A) Acute toxicity with delayed presentation  
B) Chronic toxicity — a long-term health effect following repeated exposures over time  
...
**Q38.** A chemical has a high log Kow value. What does this indicate about its environmental behavior?

A) It is highly water-soluble and will readily leach into groundwater  
B) It is lipophilic and likely to bioaccumulate in fatty tissues of organisms  
...
**Q39.** What is the significance of a chemical having a high Henry's Law constant?

A) The chemical is highly toxic through dermal contact  
B) The chemical has a strong tendency to volatilize from water into the air  
...
**Q40.** Which of the following is the most appropriate action when a worker reports a "slight smell" of hydrogen sulfide in a confined space at the start of an entry?

A) Allow entry because the odor threshold for H₂S is well below hazardous levels  
B) Measure the atmosphere and allow entry if readings are below the PEL  
...
# BLOCK 4: GHS and SDS (Q41–Q55)

**Q41.** Under GHS/HazCom 2012, which signal word indicates a MORE severe hazard?
...
**Q42.** An employee asks where to find information about proper PPE for a specific chemical. Which SDS section should they consult?
...
**Q43.** A new employee asks which SDS section tells them if the chemical will react dangerously with other materials they are storing nearby. Which section is most relevant?

A) Section 3 — Composition/Ingredients  
...
**Q44.** Which GHS pictogram should appear on a container of concentrated sulfuric acid?

A) Skull and crossbones  
B) Corrosion pictogram  
C) Flame pictogram  
D) Exploding bomb  
...
**Q45.** The GHS "Health Hazard" pictogram (person with starburst in chest) is used for which type of hazard?

A) Acute toxicity (fatal or toxic)  
B) Skin or eye irritation  
...
**Q46.** Under OSHA HazCom 2012, which SDS sections are employers required to ensure are completed by chemical manufacturers?

A) All 16 sections equally  
B) Sections 1-11 and Section 16; Sections 12-15 are required to be present but not enforced by OSHA  
...
**Q47.** Where would you find the CAS (Chemical Abstracts Service) number on an SDS?
...
**Q48.** A container label shows the GHS "Exclamation Mark" pictogram. Which of the following hazards could this indicate?

A) Carcinogenicity  
B) Skin irritation, harmful if inhaled, or acute toxicity at a less severe level  
...
**Q49.** An employee needs to know the boiling point, melting point, and solubility of a chemical. Which SDS section contains this information?
...
**Q50.** Which section of the SDS would tell an emergency responder what type of fire extinguisher to use?
...
**Q51.** The "Gas Cylinder" GHS pictogram should appear on which type of product label?

A) Flammable aerosol sprays only  
B) All gases including compressed, liquefied, refrigerated liquefied, and dissolved gases under pressure  
C) Only toxic gases  
...
**Q52.** A hazardous chemical label is worn and illegible on a secondary container. Under OSHA HazCom, what must the employer do?

A) The container can remain in service because the primary container is labeled  
B) Re-label the secondary container immediately with at minimum the product identifier and applicable hazard warnings  
...
**Q53.** Which SDS section would you consult to find out if a chemical is listed under SARA Title III Section 313 (Toxics Release Inventory)?

A) Section 2 — Hazard Identification  
B) Section 11 — Toxicological Information  
...
**Q54.** Under HazCom 2012, chemical manufacturers are required to provide an SDS to downstream users at which point?

A) Only when specifically requested by the customer  
B) With the first shipment of a hazardous chemical and upon request thereafter  
...
**Q55.** The GHS "Environment" pictogram (fish and tree) is required on US chemical labels under OSHA HazCom 2012:

A) For all chemicals with aquatic toxicity  
B) For chemicals that are marine pollutants under DOT  
...
# BLOCK 5: RCRA Characteristics and EPA Regulatory Framework (Q56–Q70)

**Q56.** A liquid waste has a pH of 1.8. Under RCRA, this waste is classified as:
...
**Q57.** The TCLP test is used to determine which RCRA characteristic?
...
**Q58.** A waste material spontaneously reacts violently when it contacts water and generates toxic gases. Under RCRA characteristics, this is classified as:
...
**Q59.** A facility generates a waste that has a flash point of 50°C (122°F). Under RCRA, is this waste ignitable (D001)?

A) Yes — the flash point is below 60°C (140°F)  
B) No — the flash point must be below 37.8°C (100°F) to be ignitable  
...
**Q60.** The TCLP regulatory limit for lead is 5.0 mg/L. A waste sample TCLP result shows lead at 4.8 mg/L. How is this waste classified?

A) D008 hazardous waste — lead characteristic  
B) Not hazardous for the toxicity characteristic for lead  
...
**Q61.** What does "cradle-to-grave" mean in the context of RCRA?

A) EPA tracks chemicals from manufacture to consumer purchase only  
B) Hazardous waste is tracked and regulated from the point of generation through storage, transport, treatment, and final disposal  
...
**Q62.** A waste appears on EPA's F001 list. What type of hazardous waste list does F001 represent?

A) Acutely hazardous wastes from specific industries  
B) Wastes from non-specific sources (spent halogenated solvents used in degreasing)  
...
**Q63.** A chemical product is no longer needed and will be discarded unused in its original container. Which RCRA listed waste category would potentially apply?
...
**Q64.** Under RCRA, which generator category must comply with the most stringent regulations and has NO exemption from manifesting requirements?
...
**Q65.** The Pollution Prevention Act of 1990 established a clear hierarchy for managing chemicals. According to this hierarchy, which option should a facility pursue FIRST?

A) Treat the waste before disposal  
B) Recycle or reuse the waste on-site  
...
**Q66.** A facility manufactures pesticides and generates wastes from that specific process. These wastes would appear on which RCRA list?

A) F-list — non-specific source wastes  
B) K-list — source-specific industry wastes  
...
**Q67.** Under RCRA, a material is considered a "solid waste" before it can be considered a "hazardous waste." Which of the following is NOT considered a solid waste under RCRA?

A) A liquid waste disposed of by injection into the ground  
B) A sludge from a wastewater treatment plant  
...
**Q68.** Which federal law specifically established the concept of Superfund for cleaning up contaminated sites?
...
**Q69.** The TCLP regulatory limit for mercury is 0.2 mg/L. A laboratory tests a waste and finds mercury at 0.15 mg/L in the TCLP extract. Then the lab finds the sample contained a D001 ignitable characteristic. What is the correct RCRA classification?

A) Not hazardous — mercury is below the TCLP limit  
B) D001 only — ignitable hazardous waste  
...
**Q70.** Under RCRA, who is the "generator" of a hazardous waste?

A) The company that transports the waste to the disposal facility  
B) The person whose act or process first causes a material to become a hazardous waste  
...
# BLOCK 6: Regulatory Framework and Planning (Q71–Q85)

**Q71.** EPCRA Section 302 requires facilities to notify the LEPC if they have Extremely Hazardous Substances (EHS) above a Threshold Planning Quantity (TPQ). What is the purpose of this notification?

A) To pay a fee to the state for the right to store the material  
B) To enable local emergency planning committees to plan appropriate emergency responses for the community  
...
**Q72.** Tier II reports under EPCRA Section 312 must be submitted annually to which entities?
...
**Q73.** Under OSHA's PSM standard (29 CFR 1910.119), which facilities are covered?

A) All facilities that use any amount of hazardous chemicals  
B) Facilities that have listed highly hazardous chemicals at or above specified threshold quantities  
...
**Q74.** OSHA HAZWOPER (29 CFR 1910.120) applies to which workers?

A) All workers who handle any hazardous chemical in the workplace  
B) Workers involved in hazardous waste operations, treatment/storage/disposal facilities, and emergency response to hazardous substance releases  
...
**Q75.** A confined space at an industrial facility is "permit-required" when:

A) It is large enough for a worker to enter and has a restricted entry  
B) It contains or has a potential to contain a serious safety or health hazard in addition to being large enough to enter and having limited means of entry/exit  
...
**Q76.** The Toxics Release Inventory (TRI) program under EPCRA Section 313 requires which type of reporting?

A) Annual reporting of hazardous waste generation quantities to the LEPC  
B) Annual reporting of toxic chemical releases to the environment and waste management quantities to EPA  
...
**Q77.** Which OSHA regulation governs the respiratory protection program requirements for workers who may be exposed to hazardous airborne contaminants?

A) 29 CFR 1910.120 (HAZWOPER)  
B) 29 CFR 1910.134 (Respiratory Protection)  
...
**Q78.** Under TSCA, which statement accurately describes EPA's authority?

A) EPA can only regulate chemicals after adverse health effects have been documented in humans  
B) TSCA gives EPA authority to require testing and to restrict or ban chemical substances that pose unreasonable risks  
...
**Q79.** A facility manager wants to know if the local fire department's response plan accounts for the large chlorine storage tank at their facility. What EPCRA provision ensures this information has been shared with the LEPC?

A) EPCRA Section 304 — Emergency Release Notification  
B) EPCRA Section 302 — Extremely Hazardous Substance Notification and Emergency Planning  
...
**Q80.** A facility releases 2 pounds of trichloroethylene (TCE), which has a CERCLA Reportable Quantity of 100 pounds. Is notification to the National Response Center required?

A) Yes, any release of a hazardous substance requires NRC notification  
B) No, notification is only required if the release equals or exceeds the Reportable Quantity of 100 pounds  
...
**Q81.** NFPA 704 is designed for use on:

A) Individual chemical containers and shipping packages  
B) Fixed facility structures such as buildings, tanks, and storage areas  
...
**Q82.** A company stores 10,000 pounds of ammonia, which is an Extremely Hazardous Substance under EPCRA. The TPQ for ammonia is 500 pounds. Which OSHA standard is ALSO likely triggered by this quantity?
...
**Q83.** What is the primary purpose of a Hazardous Materials Business Plan (HMBP)?

A) To document a company's hazardous waste generation history for EPA  
B) To provide emergency responders and planning agencies with information about hazardous materials at a facility so they can plan appropriate responses  
...
**Q84.** The Clean Air Act's Risk Management Program (RMP) under Section 112(r) requires facilities to:

A) Obtain air quality permits for all chemical emissions  
B) Develop and submit a Risk Management Plan if they have regulated substances above threshold quantities, covering worst-case scenario analysis and accident history  
...
**Q85.** A facility discharges industrial wastewater containing hazardous chemicals to a navigable waterway without a permit. This violates which law, and to whom must the spill be reported?

A) RCRA; report to the state environmental agency  
B) Clean Water Act (CWA); report to the National Response Center  
...
# BLOCK 7: Building Surveys, Chemical Properties Advanced, and Mixed Scenarios (Q86–100)

**Q86.** A building constructed in 1965 is being renovated. Which hazardous material is most likely to be encountered that requires a building survey before demolition begins?
...
**Q87.** During a building survey, inspectors find a substance they suspect is asbestos. What must be done before proceeding with renovation?

A) Remove the material immediately as a precautionary measure  
B) Sample and analyze the material by an accredited laboratory using Polarized Light Microscopy (PLM) or Transmission Electron Microscopy (TEM)  
...
**Q88.** Lead-based paint (LBP) in a residential building is considered a hazard primarily in which scenario?

A) When it is intact and in good condition on interior walls  
B) When it is deteriorated, chalking, chipping, or subject to impact/friction that creates lead dust or chips  
...
**Q89.** PCBs (polychlorinated biphenyls) in a building survey are most likely to be found in:

A) Drinking water systems  
B) Electrical transformers and capacitors manufactured before 1979  
...
**Q90.** A risk assessment determines that a chemical exposure scenario results in an incremental lifetime cancer risk of 1 × 10⁻⁴ (1 in 10,000). How does EPA generally interpret this value?

A) This risk is acceptable — EPA's acceptable risk range is 10⁻⁴ to 10⁻²  
B) This is at the upper end of EPA's acceptable risk range of 10⁻⁶ to 10⁻⁴ and may require action  
...
**Q91.** You are selecting a fire extinguisher for a laboratory that stores flammable solvents and electrical equipment. Which type is most appropriate?

A) Class A (water-based)  
B) Class B only (CO₂ or dry chemical for flammable liquids)  
...
**Q92.** A chemical has a Koc of 50,000. What does this tell a site assessor about its behavior at a contaminated site?

A) The chemical is highly mobile in groundwater and will spread quickly  
B) The chemical has low water solubility and binds strongly to soil organic matter, limiting its mobility in groundwater  
...
**Q93.** Which of the following is a characteristic of persistent organic pollutants (POPs) that makes them globally significant?

A) They degrade rapidly in sunlight and pose only local risks  
B) They are highly water-soluble and quickly dilute in aquatic environments  
...
**Q94.** OSHA's PEL for a chemical is 100 ppm TWA, but ACGIH's current TLV-TWA is 25 ppm for the same chemical. Which value should a health and safety professional use as their exposure target?

A) The OSHA PEL of 100 ppm — it is legally enforceable so it is the authoritative standard  
B) The lower ACGIH TLV of 25 ppm — OSHA PELs are outdated and ACGIH values reflect current science  
...
**Q95.** A material's SDS shows it is an organic peroxide. What special storage considerations apply?

A) Store with oxidizers to keep oxidizing capacity stable  
B) Store in cool conditions away from heat, ignition sources, and incompatible materials including flammables and oxidizers; temperature control is critical  
...
**Q96.** A scenario describes a worker mixing chlorine bleach with a commercial ammonia-based cleaner. What toxic gas is produced?
...
**Q97.** Mixing hydrochloric acid (HCl) with a cyanide salt in laboratory waste creates which hazard?

A) Explosive reaction producing heat and light  
B) Toxic hydrogen cyanide (HCN) gas — immediately dangerous to life  
...
**Q98.** Radon is a naturally occurring radioactive gas. In the context of building surveys, which location poses the greatest radon risk?

A) Upper floors of high-rise buildings  
B) Below-grade spaces such as basements and crawl spaces with poor ventilation, particularly in geological formations containing uranium-bearing soils  
...
**Q99.** A facility manager is developing a hazardous materials storage plan. Drums of sulfuric acid and drums of sodium cyanide are both received. What is the critical storage rule?

A) Both can be stored in the same corrosives cabinet since cyanide is not corrosive  
B) They must be segregated — acids mixed with cyanides produce lethal HCN gas  
...
**Q100.** According to the Pollution Prevention Act hierarchy, a manufacturing plant is generating large amounts of a solvent waste. An engineer proposes switching to an aqueous-based cleaning process that generates no hazardous waste. This action represents:

A) Treatment — converting hazardous waste to a non-hazardous form  
B) Recycling — reusing the solvent in a different process  
...
| Block | Questions | Topics |
|-------|-----------|--------|
| Block 1 | Q1-10 | Regulatory definitions and agency roles |
| Block 2 | Q11-25 | Flammability, DOT classes, NFPA 704 |
| Block 3 | Q26-40 | Toxicology, exposure limits, environmental fate |
| Block 4 | Q41-55 | GHS, SDS 16 sections, pictograms |
| Block 5 | Q56-70 | RCRA characteristics, listed wastes |
| Block 6 | Q71-85 | EPCRA, OSHA standards, regulatory framework |
| Block 7 | Q86-100 | Building surveys, incompatibilities, mixed scenarios |

**Target Score:** 80+ correct = strong foundation. Below 70 = go back to that block's Day 1 material before Day 2.

---

Ready for Day 2 whenever you are, VB — EPCRA deep dive, TRI, CERCLA liability, and building survey regulations coming next.
